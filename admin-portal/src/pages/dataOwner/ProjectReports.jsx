...
import { PROJECT_REPORTS } from '../../data/dataOwner'
import { Download } from 'lucide-react'

export default function ProjectReports() {
  const { data, loading, error } = useMockQuery(() => fetchMock(PROJECT_REPORTS), [])
    ...
    <div className="flex min-h-svh bg-canvas">
      ...
      <main className="flex-1 px-10 py-8">
        <PageHeader
          ...
          subtitle="Collection and QA summaries generated for each project."
        />
